...
test.describe("Terminal - Command and Path Handling", () => {
    test.beforeEach(async ({ page, baseURL }) => {
        ...
        const terminalDockItem = page.locator(
            '.dock-item[data-window-id="terminal-modal"]',
        );
    ...
    test("should execute ls command", async ({ page }) => {
        ...
        const hasWelcomeFile = output.some((line) =>
            line.includes("welcome.txt"),
        );
    ...
    test("should cat file with relative path from subdirectory", async ({
        page,
    }) => {
        await executeCommand(page, "cd Documents");
