...
test.describe("Launchpad Basic Functionality", () => {
    ...
    test("should display apps grid", async ({ page }) => {
        // Open launchpad
        await page
            .locator('#dock .dock-item[data-window-id="launchpad-modal"]')
            .click();
    ...
    test("should close launchpad when clicking background", async ({
        page,
    }) => {
        // Open launchpad
        await page
    ...
    test("should open app and close launchpad when clicking app", async ({
        page,
    }) => {
        // Open launchpad
        await page
    ...
    test("should close launchpad when clicking dock icon while launchpad is open", async ({
        ...
        const finderDockIcon = page.locator(
            '#dock .dock-item[data-window-id="finder-modal"]',
        );
