...
const PROGRAM_ICON_SETS: Record<ProgramIconTheme, Record<ProgramIconKey, string>> = {
    ...
    custom: {
        finder: './src/ts/apps/finder/sucher.png',
        preview: './src/ts/apps/preview/imageviewer-app-icon.svg',
        textEditor: './src/ts/apps/text-editor/notepad.png',
        codeEditor: './src/ts/apps/code-editor/code-editor-app-icon.svg',
        terminal: './src/ts/apps/terminal/terminal.png',
        photos: './src/ts/apps/photos/photos-app-icon.svg',
        calendar: './src/ts/apps/calendar/calendar-app-icon.svg',
        launchpad: './img/launchpad.png',
        profile: './src/ts/apps/about/profil.jpg',
        settings: './src/ts/apps/settings/settings-app-icon.svg',
        default: './src/ts/apps/finder/sucher.png',
    },
};
