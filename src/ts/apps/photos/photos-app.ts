    ...
    function createPhotosContent(): { container: HTMLElement; detailOverlay: HTMLElement } {
        ...
        topbar.innerHTML = `
            ...
            <div class="photos-toolbar-cluster app-toolbar-section finder-no-drag mx-auto flex items-center rounded-full border border-gray-200/85 bg-white/90 p-1 text-sm shadow-sm backdrop-blur-md dark:border-gray-700/85 dark:bg-gray-900/85" role="group" aria-label="${t('photos.toolbar.viewMode', 'Ansichtsmodus')}">
                <button type="button" data-photos-segment="years" data-active="true" aria-pressed="true" class="photos-segment-button app-toolbar-segment-button macui-button">${t('photos.segments.years', 'Years')}</button>
                <button type="button" data-photos-segment="moments" data-active="false" aria-pressed="false" class="photos-segment-button app-toolbar-segment-button macui-button">${t('photos.segments.months', 'Months')}</button>
                <button type="button" data-photos-segment="albums" data-active="false" aria-pressed="false" class="photos-segment-button app-toolbar-segment-button macui-button">${t('photos.segments.allPhotos', 'All photos')}</button>
            </div>
