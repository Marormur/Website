...
function renderIconIntoElement(target, svgMarkup, fallbackKey) {
    ...
    // Fallback to emoji
    const fallback = fallbackKey ? ICON_FALLBACK_EMOJI[fallbackKey] : undefined;
    if (fallback) {
...
if (typeof window !== 'undefined') {
    window.IconSystem = IconSystemInstance;
}
exports.default = IconSystemInstance;
