            ...
            <div class="launchpad-container">
                <div class="launchpad-search">
                    <input
                        ...
                        type="text"
                        placeholder="${(0, i18n_1.translate)('modals.launchpad.searchPlaceholder') || 'Search apps'}"
        ...
        windowIds.forEach(id => {
            ...
            if (info) {
                allApps.push({
                    ...
                    name:
                        info.programLabel ||
                        (0, i18n_1.translate)('programs.default.label') ||
                        'App',
        ...
        if (filteredApps.length === 0) {
            appsGrid.innerHTML = `
                <div class="launchpad-empty">
                    <p>${(0, i18n_1.translate)('finder.empty') || 'No apps found'}</p>
                </div>
            `;
            return;
        }
