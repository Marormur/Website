...
(() => {
    ...
    class TextEditorInstance extends Base {
        ...
        attachEventListeners() {
            ...
            if (!this._skipInitialRender && this.state && this.state.content && this.editor) {
        ...
        toggleWrapMode() {
            ...
            try {
                (0, storage_utils_js_1.setString)(
    ...
    if (InstanceManager) {
        ...
        try {
            console.debug('TextEditorInstanceManager created', {
                type: G['TextEditorInstanceManager']?.type,
                instanceCount: G['TextEditorInstanceManager']?.getInstanceCount?.(),
            });
        } catch (_) {}
    }
})();
