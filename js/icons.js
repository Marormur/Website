 ...
 * @param {string} svgMarkup - SVG-String
 * @returns {string} SVG mit xmlns
 */
 ...
 * @param {string} iconKey - Schlüssel des Icons
 * @returns {string} SVG-Markup mit xmlns
 */
 ...
 * @param {string} svgMarkup - SVG-String
 * @param {string} fallbackKey - Schlüssel für Emoji-Fallback
 */
