...
const virtual_fs_js_1 = require('../../services/virtual-fs.js');
const preview_instance_manager_js_1 = __importDefault(
    require('../../windows/preview-instance-manager.js')
);
                        ...
                        if (imageExts.has(ext)) {
                            ...
                            try {
                                ...
                                if (resp.ok) {
                                    ...
                                    if (
                                        preview_instance_manager_js_1.default &&
                                        typeof preview_instance_manager_js_1.default.openImages ===
                                            'function'
                                    ) {
                                        preview_instance_manager_js_1.default.openImages(
                                            [obj],
                                            0,
                                            subPath
                                        );
